...
class ModelRunner:
    ...
    def __init__(
        ...
        self.noise_factor = server_args.noise_factor
        self.noise_on_logits = server_args.noise_on_logits
        self.noise_on_inputs = server_args.noise_on_inputs
        self.noise_gaussian = server_args.noise_gaussian
        self.noise_gumbel = server_args.noise_gumbel
        # ==========
    ...
    def forward_extend(
        ...
        if self.is_generation:
            if forward_batch.input_embeds is None:
                # print(f"ids_Size {forward_batch.input_ids.size()}")
                # print(f"positions_Size {forward_batch.positions.size()}")
                # print(f"topk_probs_Size {forward_batch.topk_probs.size()}")
                # print(f"topk_indices_Size {forward_batch.topk_indices.size()}")
                return self.model.forward(
                    forward_batch.input_ids, forward_batch.positions, forward_batch
                )
            else:
