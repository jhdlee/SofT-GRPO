...
class SamplingBatchInfo:
    ...
    noise_factor: Optional[torch.Tensor] = None
    noise_gaussian: bool = None
    noise_gumbel: bool = None
    noise_on_logits: bool = None
    noise_on_inputs: bool = None
    ...
    def from_schedule_batch(cls, batch: ScheduleBatch, vocab_size: int):
        ...
        noise_factor = torch.tensor(
            [r.sampling_params.noise_factor for r in reqs], dtype=torch.float
        ).to(device, non_blocking=True)
        # ==========
        # end of soft thinking
        # ==========
        ...
        ret = cls(
            ...
            noise_gaussian=any(r.sampling_params.noise_gaussian for r in reqs),
            noise_gumbel=any(r.sampling_params.noise_gumbel for r in reqs),
            noise_on_logits=any(r.sampling_params.noise_on_logits for r in reqs),
            noise_on_inputs=any(r.sampling_params.noise_on_inputs for r in reqs),
