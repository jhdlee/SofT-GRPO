...
class Req:
    ...
    def __init__(
        ...
        if return_logprob:
            ...
            self.output_token_logprobs_val = self.output_token_gumbels_val = self.output_token_logprobs_idx = (
                self.output_top_logprobs_val
    ...
    def get_output_topk_gumbel_list(self):
        if self.output_topk_gumbel_list_tmp:
